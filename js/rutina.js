...
/* series: nº de series objetivo | min-max: rango de repeticiones objetivo
   unidad: 'reps' o 'seg' | porPierna: repeticiones por pierna
   lado: 'uni' si cada lado lleva su carga (mancuerna en cada mano, muñequera,
         una pierna); si no se pone, 'bi' (barra, máquina, polea con barra)
   pesoCorporal: el peso apuntado es lastre (0 = peso corporal, negativo = asistencia)
   musculo: grupo principal, solo para el contador de volumen semanal */
const EJERCICIOS = {
  // --- Día 1: Empuje ---
  press_inclinado_mancuernas: { nombre: 'Press inclinado con mancuernas', grupo: 'press_remo', musculo: 'pecho', series: 4, min: 6, max: 8, lado: 'uni' },
  fondos_paralelas:           { nombre: 'Fondos en paralelas', grupo: 'press_remo', musculo: 'pecho', series: 3, min: 8, max: 10, pesoCorporal: true },
  press_militar_mancuernas:   { nombre: 'Press militar sentado con mancuernas', grupo: 'press_remo', musculo: 'hombro', series: 3, min: 8, max: 10, lado: 'uni' },
  elevaciones_laterales:      { nombre: 'Elevaciones laterales', grupo: 'brazo_hombro', musculo: 'hombro', series: 4, min: 12, max: 15, lado: 'uni' },
  ...
  // --- Día 2: Tirón ---
  dominadas:                  { nombre: 'Dominadas', grupo: 'press_remo', musculo: 'espalda', series: 4, min: 6, max: 8, pesoCorporal: true },
  ...
  curl_martillo:              { nombre: 'Curl martillo', grupo: 'brazo_hombro', musculo: 'biceps', series: 3, min: 10, max: 12, lado: 'uni' },
  ...
  sentadilla_bulgara:         { nombre: 'Sentadilla búlgara', grupo: 'pierna', musculo: 'cuadriceps', series: 3, min: 8, max: 10, porPierna: true, lado: 'uni' },
  ...
  pajaros_deltoide_posterior: { nombre: 'Pájaros para deltoide posterior', grupo: 'brazo_hombro', musculo: 'hombro', series: 3, min: 15, max: 15, lado: 'uni' },
  curl_inclinado_banco:       { nombre: 'Curl inclinado en banco', grupo: 'brazo_hombro', musculo: 'biceps', series: 3, min: 10, max: 12, lado: 'uni' },
...
const Rutina = {
  ...
  /* Forma por defecto de un ejercicio: 'uni' (cada lado con su carga) o 'bi'
     (una carga para los dos). En la sesión se puede cambiar con el interruptor. */
  ladoPorDefecto(id) { return (EJERCICIOS[id] && EJERCICIOS[id].lado) || 'bi'; },
  /* Ejercicio con el propio cuerpo: el peso es lastre */
  pesoCorporal(id) { return !!(EJERCICIOS[id] && EJERCICIOS[id].pesoCorporal); },
